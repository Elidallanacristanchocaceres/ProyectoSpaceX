export const tableCapsulesColum1 = async (Capsules)=>{
    ...
    strong1.textContent = `${(Capsules.active) ? "Active" : "Low" }`
    ...
    strong2.textContent = `${Capsules.stages}`
    ...
    strong3.textContent = `${Capsules.boosters}`
    ...
    strong4.textContent = `${Capsules.type}`
    ...
    strong5.textContent = `${Capsules.LandLandings}`
    ...
    strong6.textContent = `${(Capsules.LandLandings) ? Capsules.LandLandings.status : ""}`
...
export const tableCapsulesColum2 = async (Capsules)=>{
    ...
    let strong1 = document.createElement("strong");
    strong1.textContent = `${(Capsules.last_update.last_update) ? Capsules.last_update.last_update : 0}`
    div1.append(span1, strong1)
    ...
    let strong2 = document.createElement("strong");
    strong2.textContent = `${(Capsules.last_update.layout) ? Capsules.last_update.layout : ""}`
    div2.append(span2, strong2)
    ...
    let strong3 = document.createElement("strong");
    strong3.textContent = `${(Capsules.last_update.number) ? Capsules.last_update.number : 0}`
    div3.append(span3, strong3)
    ...
    let strong4 = document.createElement("strong");
    strong4.textContent = `${(Capsules.last_update.propellant_1) ? Capsules.last_update.propellant_1 : ""}`
    div4.append(span4, strong4)
    ...
    let strong5 = document.createElement("strong");
    strong5.textContent = `${(Capsules.last_update.propellant_2) ? Capsules.last_update.propellant_2 : ""}`
    div5.append(span5, strong5)
    ...
    let strong6 = document.createElement("strong");
    strong6.textContent = `${(Capsules.last_update.type) ? Capsules.last_update.type : 0} ${(Capsules.last_update.version) ? Capsules.last_update.status : ""}`
    div6.append(span6, strong6)
