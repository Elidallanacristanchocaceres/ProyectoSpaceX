...
/*INFORMACION DE CIRUCLOS */
                ...
                export const informRocketEngineThrustVacuum = async(thrust_vacuum)=>{
                    ...
                    let divFirst = document.createElement('div');
                    divFirst.classList.add("item__progress__bar");
                    divFirst.style = `background: radial-gradient(closest-side, #1d1f38 85%, transparent 85% 100%), conic-gradient(var(--color--six) ${pocentaje}%, transparent 0)`
                    let divFirstChildren = document.createElement('div');
                    divFirstChildren.classList.add("progress__value")
                    let strong = document.createElement('strong');
...
/*INFORMACION DE LA DERECHA BARAS DE COLORES*/
    import { 
        getRocketMassTotal, 
    ...
    export const progressRocketWeight = async (Rockets) => {
        ...
        [Rockets].forEach((val) => {
            ...
            labelFist.textContent = "Weight :";
    
            let ProgressFist = document.createElement("progress");
            ProgressFist.max = kg; // Máximo establecido en el total que has obtenido
            ProgressFist.value = val.mass.kg; // Asegúrate de que val.mass.kg es el correcto
    
            // Cambiar el color del progreso según el valor
            if (ProgressFist.value < 30000) {
                ProgressFist.style.setProperty('--color', '#e52d2d'); // Rojo
            } else if (ProgressFist.value < 60000) {
                ProgressFist.style.setProperty('--color', '#ff8c00'); // Naranja
            } else if (ProgressFist.value < 80000) {
                ProgressFist.style.setProperty('--color', '#298bfe'); // Azul
            } else {
                ProgressFist.style.setProperty('--color', '#4caf50'); // Verde
            }
    ...
    export const progressDiameterRocket = async(Rockets)=>{
        ...
        [Rockets.diameter].forEach(val => {
            ...
            let divFirst = document.createElement("div");
            let labelFist = document.createElement("label");
            labelFist.textContent = `Diameter :`;
    ...
    export const progressSecondStageDiameterRocket = async(Rockets)=>{
        ...
        [Rockets.second_stage.payloads.composite_fairing.diameter].forEach(val => {
            ...
            let divFirst = document.createElement("div");
            let labelFist = document.createElement("label");
            labelFist.textContent = `Diameter Of Shield :`;
    ...
    export const progressSecondStageHeightRocket = async(Rockets)=>{
        ...
        [Rockets.second_stage.payloads.composite_fairing.height].forEach(val => {
            ...
            let divFirst = document.createElement("div");
            let labelFist = document.createElement("label");
            labelFist.textContent = `Height Of Shield :`;
